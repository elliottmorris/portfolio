...
gg <- ggplot(df %>%
  ...
  scale_x_continuous(labels=scales::percent_format(1),breaks=c(-.30,-.20,-.10,0,.10,.20,.30)) +
  scale_y_continuous(labels=scales::percent_format(1),breaks=c(-.30,-.20,-.10,0,.10,.20,.30))
